...
* Para qué se usó (corrección de texto, búsqueda de ideas, generación de código...).
* En qué fase del trabajo intervino.

## Verificación de autoría en trabajos de alto peso

En proyectos o trabajos que valgan más del 30% de la nota, incluir alguno de estos mecanismos (basta con uno):

* Una pregunta oral de 5 minutos en la revisión: "¿por qué elegiste este diseño?", "¿cómo funciona esta parte?".
* Entrega escalonada con al menos un hito intermedio (esquema, prototipo, versión parcial).
...
El mecanismo de trazabilidad de autoría en esta titulación es el repositorio Git con historial de commits. El historial de commits acredita fecha, hora, progresión del trabajo y autoría. Cubre simultáneamente la verificación de autoría (punto 4) y el trabajo supervisado en sesiones de laboratorio (punto 3).

Incluir en la guía docente:

> "El historial del repositorio Git constituye el registro de trazabilidad de autoría de esta asignatura."

## Régimen sancionador y reclamaciones

El régimen sancionador está pendiente de actualización del reglamento académico del alumno a nivel institucional. En tanto no se resuelva, las infracciones detectadas se gestionan conforme al reglamento vigente.
